...
router.get('/:id', /*validation.isValidId, isAuthenticated,*/ usersController.getUserById); // Get user by id 
...
router.put('/:id', /*validation.isValidId, validation.someSortOfRule, isAuthenticated,*/ usersController.updateUser); // Update user if authenticated as admin or user 
router.delete('/:id', /*validation.isValidId, isAuthenticated,*/ usersController.deleteUser); // Delete user by ID 
