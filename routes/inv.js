...
router.post('/', /*validation.someSortOfRule, isAuthenticated,*/ invController.createItem); // create new inventory 
router.put('/:id', /*validation.isValidId, isAuthenticated,*/ invController.updateItem); // update inventory 
router.delete('/:id', /*validation.isValidId, isAuthenticated,*/ invController.deleteItem); // delete inventory 
