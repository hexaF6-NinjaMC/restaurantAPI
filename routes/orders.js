...
router.put('/:id', /*validation.isValidId, validation.someSortOfRule, isAuthenticated,*/ ordersController.updateOrder); // Updates an order based on order ID 
router.delete('/:id', /*validation.isValidId, isAuthenticated,*/ ordersController.deleteOrder); // Delete order ID for admin and user who placed order 
